...
const MoveHere = ({ className }) => {
  ...
  if (!stopped)
    return (
      <motion.div
        className={`absolute top-[50%] left-[50%]  ${className}`}
        onHoverStart={() => setStopped(true)}
        style={{ x: "-100%", opacity: 80, zIndex: 99 }}
        animate={controls}
        exit={{ opacity: 0 }}
      >
        <slot name="interaction-prompt" aria-hidden="true">
          ...
          >
            ...
            <g transform="translate(-11 -4)" fill="none" fillRule="evenodd">
              <path fillOpacity="0" fill="#fff" d="M0 0h44v44H0z"></path>
