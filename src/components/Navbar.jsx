      ...
      <div className="flex items-center justify-between w-full gap-4 m-1 mx-auto max-w-7xl">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            ...
            <p className="text-white text-[20px] font-extrabold cursor-pointer ">
              Mohab Gamal
              {/* <div
                className="inline-block ml-1 animate-blink w-2 h-4 bg-gray-300"
          ...
          <ul className="flex-row hidden gap-10 list-none md:flex">
            {navLinks.map((link) => (
              ...
              >
                ...
                <div className="w-9 h-1 bg-secondary group-hover:bg-pinkish group-hover:w-full transation-all duration-200" />
              </li>
            ))}
          </ul>
        </div>
        <div className="hidden md:flex items-center justify-center gap-1">
          ...
          <a
            ...
            target="_blank"
            className="w-10 h-10 hover:scale-125 transition-all duration-300 bg-white rounded-full shadow-md shadow-primary"
          />
          {/* Résumé button */}
          <div className="relative ml-2 py-2.5 px-4 rounded-xl text-white font-bold bg-pinkish hidden md:flex items-center justify-center gap-2 shadow-md shadow-primary hover:bg-[#d34570]">
            ...
            >
              ...
              href={CV_LINK}
              target="_blank" 
              className="p-2 flex items-center justify-between gap-5 rounded-lg hover:bg-pinkish cursor-pointer">
                <p>Preview</p>
                <img className="w-5 h-5" src={externalLink} />
              </a>
              <a
              href={CV_FILE} 
               className="p-2 flex items-center justify-center gap-5 rounded-lg hover:bg-pinkish cursor-pointer">
                <p>Download</p>
                <DownloadFileSvg />
              </a>
            </div>
          ...
          >
            ...
            <div className="flex items-center justify-center flex-wrap gap-1 mb-2">
              ...
              <a
                ...
                href="https://github.com/MohabGamal"
                target="_blank"
                className="w-8 h-8 hover:scale-125 transition-all duration-300 bg-white rounded-full shadow-md shadow-primary"
              />
            </div>
          </div>
        </div>
